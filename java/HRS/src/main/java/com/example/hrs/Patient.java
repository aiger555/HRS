...
public class Patient {
    ...
    public static void updatePatient(int id, Scanner scanner) {
    ...
    public static void viewDoctors(int loggedInPatientId) {
        String query = "SELECT u.id AS doctor_id, u.name AS doctor_name FROM appointments a " +
        ...
        try {
            ...
            while (resultSet.next()) {
                int doctorId = resultSet.getInt("doctor_id"); // Use correct column name
                String doctorName = resultSet.getString("doctor_name"); // Use correct column name

                // Print or process doctor information as needed
    ...
    public static void bookAppointmentP(int loggedInPatientId, Scanner scanner) {
