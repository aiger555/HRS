...
public class Doctor {
    ...
    public static void updateDoctor(int id,  Scanner scanner) {
        if (getDoctorById(id)) {
            try {
    ...
    public static void bookAppointmentD(int doctorId, Scanner scanner) {
    ...
    public static void viewPatientDetails(int patientId) {
